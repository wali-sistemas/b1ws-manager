...
public class ChatBotIAREST {
    ...
    public Response fetchItemCatalog(@QueryParam("companyname") String companyName) {
        ...
        for (Object[] obj : objs) {
            ...
            dto.setStockWhMed((Integer) obj[2]);
            dto.setStockWhCart((Integer) obj[3]);
            dto.setStockWhCal((Integer) obj[4]);
            dto.setStockWhBog((Integer) obj[5]);
            dto.setPrice((BigDecimal) obj[6]);
            dto.setCategory((String) obj[7]);
            dto.setGroup((String) obj[8]);
            dto.setSubGroup((String) obj[9]);
            dto.setBrand((String) obj[10]);
            dto.setSubBrand((String) obj[11]);
            dto.setApplication((String) obj[12]);
            dto.setOring((String) obj[13]);
            dto.setTypeInv((String) obj[14]);
            dto.setTypeTire((String) obj[15]);
            dto.setWidthTire((String) obj[16]);
            dto.setProfileTire((String) obj[17]);
            dto.setRinTire((String) obj[18]);
            dto.setColorChain((String) obj[19]);
            dto.setPasoChain((String) obj[20]);
            dto.setLongChain((String) obj[21]);
            dto.setUnitPack("1");
