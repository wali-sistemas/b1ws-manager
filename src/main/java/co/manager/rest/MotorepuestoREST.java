...
public class MotorepuestoREST {
    ...
    public Response listItemMaster() {
        ...
        for (Object[] obj : objects) {
            ...
            dto.setPictureUrl(managerApplicationBean.obtenerValorPropiedad(Constants.URL_SHARED) + "images/mtz/" + obj[6]);
            dto.setMarca((String) obj[7]);
            dto.setSubMarca((String) obj[17]);
            dto.setGrupo((String) obj[8]);
            dto.setGrupo((String) obj[9]);
            dto.setModeloMoto((String) obj[10]);
            dto.setTipoLlanta((String) obj[11]);
            dto.setAnchoLlanta((String) obj[12]);
            dto.setPerfilLlanta((String) obj[13]);
            dto.setRinLlanta((String) obj[14]);
            dto.setTalla((String) obj[15]);
            dto.setCategory((String) obj[16]);
