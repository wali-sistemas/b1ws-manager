 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "LoginService", wsdlLocation = "http://192.168.10.102/B1WS/WebReferences/LoginService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.10.102/B1WS/WebReferences/LoginService.wsdl");
