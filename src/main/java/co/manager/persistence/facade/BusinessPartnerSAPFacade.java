...
public class BusinessPartnerSAPFacade {
    ...
    public List<Object[]> listCustomersBySalesPerson(String slpCode, String companyName, boolean pruebas) {
        ...
        sb.append(" cast(substring(ifnull(sn.\"Phone2\",''),1,10) as varchar(10)) as Celular, cast(upper(sn.\"E_Mail\") as varchar(50)) as Email, ");
    ...
    public List<Object[]> listCustomerPortfolioBySalesPerson(String slpCode, String cardCode, String companyName, boolean pruebas) {
        ...
        sb.append(" case when (t.valorDocumento-t.valorSaldo) > 0 or t.discPrcnt > 0 then 'N' else 'Y' end as activeCalc ");
        sb.append("from ( ");
        ...
        sb.append("  s.\"U_addInFaElectronica_email_contacto_FE\" as emailFE,cast((f.\"DocTotal\"-f.\"VatSum\"+f.\"DiscSum\"-f.\"TotalExpns\"+f.\"WTSum\")as numeric(18,0))as totalBruto,cast(f.\"DiscPrcnt\" as int)as discPrcnt ");
        ...
        sb.append("  cast((n.\"DocTotal\"-n.\"VatSum\"+n.\"DiscSum\"-n.\"TotalExpns\"+n.\"WTSum\")as numeric(18,0))as totalBruto,cast(n.\"DiscPrcnt\" as int)as discPrcnt ");
        ...
        sb.append(" group by t.cardCode,t.cardName,t.nit,t.tipoDoc,t.docNum,t.fechaEmision,t.fechaVencimiento,t.valorSaldo,t.valorDocumento,t.diasVencidos,a.\"SlpName\",c.\"PymntGroup\",t.cupo,t.uPromDiasPago,t.fechaUltComp,t.urlFacture,t.emailFE,t.totalBruto,t.discPrcnt ");
    ...
    public Object[] getCustomerData(String cardCode, String companyName, boolean testing) {
        ...
        sb.append(" cast(s.\"GroupCode\" as int)as groupCode,cast(s.\"Phone1\" as varchar(20))as phone1,cast(s.\"Phone2\" as varchar(20))as phone2,cast(s.\"E_Mail\" as varchar(100))as eMail, ");
        sb.append(" (select cast(\"U_codeResFis\" as varchar(20)) from \"@OK1_FE_RES_FIS_SN\" e left join \"@OK1_FE_RES_FIS_SN_L\" d on d.\"DocEntry\"=e.\"DocEntry\" where \"U_CardCode\"=s.\"CardCode\" and e.\"CreateDate\"=(select max(\"CreateDate\") from \"@OK1_FE_RES_FIS_SN\" where \"U_CardCode\"=s.\"CardCode\"))as uCodeResFis, ");
        sb.append(" cast(s.\"Territory\" as int)as territory,cast(s.\"SlpCode\" as varchar(5))as slpCode,cast(s.\"Free_Text\" as varchar(250))as freeText,cast(\"CntctPrsn\" as varchar(20))as idContact,cast(c.\"FirstName\" as varchar(50))as firstName, ");
        sb.append(" cast(c.\"MiddleName\" as varchar(50))as middleName,cast(c.\"LastName\" as varchar(50))as lastName,cast(c.\"Position\" as varchar(50))as position,cast(c.\"Tel1\" as varchar(20))as tel1,cast(c.\"BirthDate\" as date)as birthDate, ");
        ...
        sb.append(" cast(s.\"CreditLine\" as numeric(18,2))as creditLine,cast(s.\"CreateDate\" as date)as createDate,cast(s.\"U_TRASP\" as varchar(2))as uTrasp,cast(s.\"QryGroup4\" as varchar(1))as qryGroup4,cast(s.\"QryGroup15\" as varchar(1))as qryGroup15,cast(s.\"WTLiable\" as varchar(1))as wTLiable, ");
