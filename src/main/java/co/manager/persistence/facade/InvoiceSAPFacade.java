...
public class InvoiceSAPFacade {
    ...
    public List<String> listInvoicePurchase(String companyName, boolean testing) {
        ...
        sb.append("from OINV ");
        sb.append("where \"DocNum\" not in(1442,221) and \"DocStatus\"='O' and year(\"DocDate\")=year(current_date) and \"CardCode\"='C900998242' and cast(\"DocNum\" as varchar(100)) not in(");
