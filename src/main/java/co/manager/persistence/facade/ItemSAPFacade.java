...
public class ItemSAPFacade {
    ...
    public List<Object[]> getListItemsChatBotIABySeller(String slpCode, String companyName, boolean testing) {
        StringBuilder sb = new StringBuilder();
        sb.append("select cast(t.\"ItemCode\" as varchar(20))as articulo,cast(a.\"ItemName\" as varchar(250))as descripcion,cast(sum(\"01\")as int)as StockMedellin, ");
        sb.append(" cast(sum(\"05\")as int)as StockCartagena,cast(sum(\"26\")as int)as StockCali,cast(sum(\"35\")as int)as stockBogota,cast(p.\"Price\" as decimal(18,2))as precio, ");
