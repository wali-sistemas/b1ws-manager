...
public class ItemSAPFacade {
    ...
    public List<Object[]> getStockWarehouseCurrent(String itemCode, String whsCode, String companyName, String statusModula, boolean pruebas) {
        ...
        if (companyName.contains("VARROC")) {
            ...
            sb.append("   (select sum(de.\"OnHandQty\") from OBIN ub inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" where de.\"WhsCode\"='35' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")) else (it.\"OnHand\"-it.\"IsCommited\") end as int)as Stock ");
            sb.append(" from OITM oi ");
            sb.append(" inner join OITW it on it.\"ItemCode\"=oi.\"ItemCode\" ");
            ...
            sb.append("  from OBIN ub ");
            sb.append("  inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
            sb.append("  where de.\"WhsCode\"='45' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")>0 then (it.\"OnHand\"-it.\"IsCommited\"-");
            sb.append("   (select sum(de.\"OnHandQty\") from OBIN ub inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" where de.\"WhsCode\"='32' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")) else (it.\"OnHand\"-it.\"IsCommited\") end as int)as Stock ");
            sb.append(" from OITM oi ");
            sb.append(" inner join OITW it on it.\"ItemCode\"=oi.\"ItemCode\" ");
            sb.append(" where it.\"WhsCode\"='45' and oi.\"frozenFor\"='N' and oi.\"SellItem\"='Y' and oi.\"InvntItem\"='Y' ");
            if (!itemCode.equals("0")) {
                sb.append("and oi.\"ItemCode\"='");
                sb.append(itemCode);
                sb.append("'");
    ...
    public List<Object[]> getListItemsChatBotIABySeller(String slpCode, String companyName, boolean testing) {
        StringBuilder sb = new StringBuilder();
        sb.append("select x.* from ( ");
        sb.append(" select cast(t.\"ItemCode\" as varchar(20))as articulo,cast(a.\"ItemName\" as varchar(250))as descripcion,cast(sum(\"01\")+sum(\"05\")+sum(\"26\")+sum(\"35\")as int)as stockFull, ");
        sb.append("  cast(sum(\"01\")as int)as StockMedellin,cast(sum(\"05\")as int)as StockCartagena,cast(sum(\"26\")as int)as StockCali,cast(sum(\"35\")as int)as stockBogota,cast(p.\"Price\" as decimal(18,2))as precio, ");
        sb.append("  cast(c.\"Name\" as varchar(100))as categoria,cast(g.\"Name\" as varchar(100))as grupo,cast(s.\"Name\" as varchar(100))as subgrupo,cast(m.\"Name\" as varchar(100))as marca, ");
        sb.append("  cast(su.\"Name\" as varchar(100))as subMarca,cast(a.\"U_Aplicacion\" as varchar(255))as aplicacion,cast(pr.\"Name\" as varchar(100))as procedencia, ");
        sb.append("  cast(a.\"U_Tipo_Inventario\" as varchar(50))as tipoDeInv,cast(a.\"U_TIPO_LLANTA\" as varchar(50))as tipoDeLlanta,cast(a.\"U_ANCHO_LLANTA\" as varchar(50))as anchoDeLlanta, ");
        sb.append("  cast(a.\"U_PERFIL_LLANTA\" as varchar(50))as perfilDeLlanta,cast(a.\"U_RIN_LLANTA\" as varchar(50))as rinLlantaN,cast(a.\"U_COLOR_CADENA\" as varchar(50))as colorDeCadena, ");
        sb.append("  cast(a.\"U_PASO_CADENA\" as varchar(50))as pasoDeCadena,cast(a.\"U_LARGO_CADENA\" as varchar(50))as largoDeCadena ");
        sb.append(" from (");
        sb.append("  select \"ItemCode\",SUM(\"01\") \"01\",0 \"05\",0 \"26\",0 \"35\" ");
        sb.append("  from (");
        sb.append("   select oi.\"ItemCode\" \"ItemCode\",sum(cast(case when(");
        sb.append("    select sum(de.\"OnHandQty\")  ");
        sb.append("    from OBIN ub ");
        sb.append("    inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("    where de.\"WhsCode\"='01' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")>0 ");
        sb.append("     then (it.\"OnHand\"-it.\"IsCommited\"-");
        sb.append("      (select sum(de.\"OnHandQty\") ");
        sb.append("       from OBIN ub inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("       where de.\"WhsCode\"='01' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")) ");
        sb.append("     else (it.\"OnHand\"-it.\"IsCommited\") end as int))as \"01\" ");
        sb.append("   from OITM oi ");
        sb.append("   inner join OITW it on it.\"ItemCode\"=oi.\"ItemCode\" ");
        sb.append("   where it.\"WhsCode\"='01' and oi.\"frozenFor\"='N' and oi.\"SellItem\"='Y' and oi.\"InvntItem\"='Y' ");
        sb.append("   group by oi.\"ItemCode\" ");
        sb.append("  union all ");
        sb.append("   select oi.\"ItemCode\" \"Codigo\",sum(cast(case when(");
        sb.append("    select sum(de.\"OnHandQty\") ");
        sb.append("    from OBIN ub ");
        sb.append("    inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("    where de.\"WhsCode\" = '30' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")>0 ");
        sb.append("     then (it.\"OnHand\"-it.\"IsCommited\"-");
        sb.append("      (select sum(de.\"OnHandQty\") ");
        sb.append("       from OBIN ub inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("       where de.\"WhsCode\"= '30' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")) ");
        sb.append("     else (it.\"OnHand\"-it.\"IsCommited\") end as int))as \"01\" ");
        sb.append("   from OITM oi ");
        sb.append("   inner join OITW it on it.\"ItemCode\"=oi.\"ItemCode\" ");
        sb.append("   where it.\"WhsCode\"='30' and oi.\"frozenFor\"='N' and oi.\"SellItem\"='Y' and oi.\"InvntItem\"='Y' ");
        ...
        sb.append("  union all ");
        sb.append("  select oi.\"ItemCode\",0 \"01\",cast(case when( ");
        sb.append("   select sum(de.\"OnHandQty\") ");
        sb.append("   from OBIN ub ");
        sb.append("   inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("   where de.\"WhsCode\"='05' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")>0 ");
        sb.append("    then (it.\"OnHand\"-it.\"IsCommited\"- ");
        sb.append("     (select sum(de.\"OnHandQty\") ");
        sb.append("      from OBIN ub inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("      where de.\"WhsCode\"='05' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")) ");
        sb.append("    else (it.\"OnHand\"-it.\"IsCommited\") end as int)as \"05\",0 \"26\",0 \"35\" ");
        sb.append("   from OITM oi ");
        sb.append("   inner join OITW it on it.\"ItemCode\"=oi.\"ItemCode\" ");
        sb.append("   where it.\"WhsCode\"='05' and oi.\"frozenFor\"='N' and oi.\"SellItem\"='Y' and oi.\"InvntItem\"='Y' ");
        sb.append("  union all ");
        sb.append("   select oi.\"ItemCode\",0 \"01\", 0 \"05\",cast(case when( ");
        sb.append("    select sum(de.\"OnHandQty\") ");
        sb.append("    from OBIN ub ");
        sb.append("    inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("    where de.\"WhsCode\"='26' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")>0 ");
        sb.append("     then (it.\"OnHand\"-it.\"IsCommited\"-");
        sb.append("      (select sum(de.\"OnHandQty\") ");
        sb.append("       from OBIN ub ");
        sb.append("       inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("       where de.\"WhsCode\"='26' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")) ");
        sb.append("     else (it.\"OnHand\"-it.\"IsCommited\") end as int)as \"26\",0 \"35\" ");
        sb.append("   from OITM oi");
        sb.append("   inner join OITW it on it.\"ItemCode\"=oi.\"ItemCode\" ");
        sb.append("   where it.\"WhsCode\"='26' and oi.\"frozenFor\"='N' and oi.\"SellItem\"='Y' and oi.\"InvntItem\"='Y' ");
        sb.append("  union all ");
        sb.append("   select oi.\"ItemCode\",0 \"01\", 0 \"05\",0 \"26\",cast(case when( ");
        sb.append("    select sum(de.\"OnHandQty\") ");
        sb.append("    from OBIN ub ");
        sb.append("    inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("    where de.\"WhsCode\"='35' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")>0 ");
        sb.append("    then (it.\"OnHand\"-it.\"IsCommited\"-");
        sb.append("     (select sum(de.\"OnHandQty\") ");
        sb.append("      from OBIN ub ");
        sb.append("      inner join OIBQ de on ub.\"AbsEntry\"=de.\"BinAbs\" ");
        sb.append("      where de.\"WhsCode\"='26' and (ub.\"Attr4Val\"='' or ub.\"Attr4Val\" is null) and de.\"OnHandQty\">0 and de.\"ItemCode\"=oi.\"ItemCode\")) ");
        sb.append("    else (it.\"OnHand\"-it.\"IsCommited\") end as int)as \"35\" ");
        sb.append("   from OITM oi ");
        sb.append("   inner join OITW it on it.\"ItemCode\"=oi.\"ItemCode\" ");
        sb.append("   where it.\"WhsCode\"='35' and oi.\"frozenFor\"='N' and oi.\"SellItem\"='Y' and oi.\"InvntItem\"='Y' ");
        sb.append("  )as t ");
        sb.append(" inner join OITM a on t.\"ItemCode\"=a.\"ItemCode\" ");
        sb.append(" inner join ITM1 p on a.\"ItemCode\"=p.\"ItemCode\" ");
        sb.append(" left join \"@CATEGORIA\" c on a.\"U_CATEGORIA\"=c.\"Code\" ");
        sb.append(" left join \"@GRUPOS\" g on a.\"U_Grupo\"=g.\"Code\" ");
        sb.append(" left join \"@SUBGRUPOS\" s on a.\"U_Subgrupo\"=s.\"Code\" ");
        sb.append(" left join \"@MARCAS\" m on a.\"U_Marca\"=m.\"Code\" ");
        sb.append(" left join \"@SUBMARCA\" su on a.\"U_SUBMARCA\"=su.\"Code\" ");
        sb.append(" left join \"@PROCEDENCIAS\" pr on a.\"U_Procedencia\"=pr.\"Code\" ");
        sb.append(" where p.\"PriceList\"=4 and a.\"validFor\"='Y' and a.\"InvntItem\"='Y' ");
        sb.append(" group by t.\"ItemCode\",a.\"ItemName\",p.\"Price\",c.\"Name\",g.\"Name\",s.\"Name\",m.\"Name\",su.\"Name\",a.\"U_Aplicacion\",pr.\"Name\",a.\"U_Tipo_Inventario\",");
        sb.append("  a.\"PicturName\",a.\"U_TIPO_LLANTA\",a.\"U_ANCHO_LLANTA\",a.\"U_PERFIL_LLANTA\",a.\"U_RIN_LLANTA\",a.\"U_COLOR_CADENA\",a.\"U_PASO_CADENA\",a.\"U_LARGO_CADENA\" ");
        sb.append(")as x ");
        sb.append("where x.stockFull>0 ");
        sb.append("order by 1");
        try {
